...
(function() {
    ...
    NodeSelector.prototype.lastNode = function() {
        var node = this._targetNode.children.length - 1;
        nodeGot = this._targetNode.getNodeAt(node);
        return SceneJS._selectNode(nodeGot);
    }
...
(function() {
    ...
    SceneJS.createNodeType("nil", "layer");
})();
...
// (function() {
//     var Nil = SceneJS.createNodeType("nil", "geometry");
//     Nil.prototype._init = function(params) {
//         SceneJS_geometry.prototype._init.call(this, {
//             coreId : params.coreId || "nil_" + Math.floor(Math.random() * 10000),
//             create: function() {
//                 return {
//                     primitive : "lines"
//                 };
